...
import com.github.softwarevax.lock.configuration.DefaultThreadFactory;
import com.github.softwarevax.lock.configuration.LockConstant;
import com.github.softwarevax.lock.configuration.annotation.Lock;
import com.github.softwarevax.lock.configuration.enums.LockEnum;
import com.github.softwarevax.lock.service.LockService;
import com.github.softwarevax.lock.service.impl.DatabaseLockServiceImpl;
import com.github.softwarevax.lock.service.impl.RedisLockServiceImpl;
...
public class DistributeLockAspect implements SmartInitializingSingleton, ApplicationContextAware {
    ...
    // order = 1
    @Before(value = "@annotation(com.github.softwarevax.lock.configuration.annotation.Lock)")
    ...
    // order = 2
    @Around(value = "@annotation(com.github.softwarevax.lock.configuration.annotation.Lock)")
    ...
    // order = 3
    @After(value = "@annotation(com.github.softwarevax.lock.configuration.annotation.Lock)")
    public void after(JoinPoint joinPoint){
    }

    // order = 4
    @AfterReturning(pointcut = "@annotation(com.github.softwarevax.lock.configuration.annotation.Lock)",returning = "ret")
    ...
    // order = 方法抛出异常时
    @AfterThrowing(pointcut = "@annotation(com.github.softwarevax.lock.configuration.annotation.Lock)",throwing = "ex")
